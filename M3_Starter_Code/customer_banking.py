...
def main():
    ...
    updated_cd_balance, interest_earned = create_savings_account(savings_balance, savings_interest_rate, savings_months)
    ...
    # ADD YOUR CODE HERE
    cd_balance_balance = float(input("How much money do you currently have in your CD account: $ "))
